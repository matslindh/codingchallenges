        ...
        for x in floor:
            if x[0] == 'G':
                ...
                for floor2 in floors:
                    ...
                    for y in floor2:
                        if y[0] == 'M' and y[1:] == x[1:]:
                            found = True
                            entries.append('G' + str(fidx - y_idx))
                            break
...
def step(floors, lift_on=0, steps=0):
    ...
    while queue:
        ...
        #print_floors(floors, lift_on, steps)
        #print(cs)

        if cs.startswith('0:|1:|2:|3:G0_G0_G0_G0_G0_G0_G0|'):
            print(steps)
...
print(checksum(0, initial_floors))
